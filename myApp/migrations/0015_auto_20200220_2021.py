...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2020, 2, 20, 14, 51, 28, 957460, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='categories',
            name='categoryTimeOfCreation',
            field=models.DateTimeField(default=datetime.datetime(2020, 2, 20, 14, 51, 28, 956429, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='items',
